...
<html>
<head>
<title>Ski Learn:: Premium account</title>
<!-- Custom Theme files -->
...
<div class="login-form">
			<div class="login-top">
        <h3 class="log-intro">Complete your Ski Premium Plan Account</h3>
			<form>
				<div class="login-ic">
					<i ></i>
				...
				<a class="btn btn-block btn-lg btn-info" disabled>
    <span class="fa fa-usd"></span>  Premium Account
  </a>
				<div class="log-bwn" >
