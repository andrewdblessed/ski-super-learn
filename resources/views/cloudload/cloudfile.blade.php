                                    <div class="btn-toolbar m-t-20" role="toolbar">
                                                        <div class="btn-group">
                                                            <button type="button" class="btn btn-primary waves-effect waves-light "><i class=" mdi mdi-information"></i></button>
                                                            <button type="button" class="btn btn-danger waves-effect waves-light deleteFile{{$file->id}}"><i class=" mdi mdi-delete"></i></button>
                                                        </div>
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="/user_uploads/{{$file->filename}}" class="btn btn-primary waves-effect waves-light  pull-right" >
...
<img src="/user_uploads/{{$file->filename}}">
